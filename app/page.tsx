...
function ProjectVisual({ project }: { project: (typeof projects)[number] }) {
  return <div className={`visual visual-${project.tone}`}>
    ...
    {project.id === 8 && <><div className="contor-brand">◉ CONTOR ACASĂ</div><div className="contor-ui"><div className="contor-side"><i/><i/><i/><i/></div><div className="contor-main"><small>BUNĂ, CRISTIAN</small><div className="contor-bars"><i/><i/><i/><i/><i/></div></div><div className="contor-card"><b>+128</b><span>CONSUMATORI</span></div></div><div className="contor-badge">MULTI-ZONĂ · 3 ROLURI</div></>}
