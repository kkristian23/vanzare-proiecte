...
export const romanianCategories: Category[] = [
  ...
  { title: "Preț, licență & plată", code: "02", description: "Claritate înainte de investiție.", questions: [
    ...
    ["Pot revinde proiectul după cumpărare?", "Drepturile de revânzare depind de licența proiectului și de licențele resurselor incluse; le clarificăm în oferta agreată."],
  ...
  { title: "SEO & performanță", code: "07", description: "Vizibil, rapid, pregătit pentru creștere.", questions: [
    ...
    ["Pot avea pagini locale pentru orașe?", "Da, pentru locații și servicii reale, cu informații utile specifice fiecărei pagini. Nu recomandăm pagini identice create doar pentru numele orașelor."],
