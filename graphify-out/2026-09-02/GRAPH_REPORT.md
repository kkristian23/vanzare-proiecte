...
Cohesion: 0.12
Nodes (23): contactCopy, copy, descriptions, localDescription(), Locale, locales, localizedDetail(), localType() (+15 more)
...
## Knowledge Gaps
- **116 isolated node(s):** `metadata`, `typeMap`, `romanianTypeMap`, `descriptions`, `geist` (+111 more)
