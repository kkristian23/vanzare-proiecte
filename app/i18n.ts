...
export const contactCopy = cmsContent("i18n-contactCopy", {
  ro: {
    ...
    accepted: "EMAIL PREGĂTIT", emailReady: "Verifică și trimite mesajul din aplicația de email.",
    emailFallback: "Deschiderea aplicației nu confirmă trimiterea. Dacă nu s-a deschis, scrie-ne direct la monodev@gmail.com.", another: "Creează altă cerere",
    ...
    submit: "PREGĂTEȘTE EMAILUL", copyEmail: "Copiază adresa de email", copiedEmail: "Adresa de email a fost copiată",
  ...
  ru: {
    ...
    accepted: "ПИСЬМО ПОДГОТОВЛЕНО", emailReady: "Проверьте и отправьте сообщение в почтовой программе.",
    emailFallback: "Открытие программы не подтверждает отправку. Если она не открылась, напишите на monodev@gmail.com.", another: "Создать новую заявку",
    ...
    submit: "ПОДГОТОВИТЬ ПИСЬМО", copyEmail: "Скопировать адрес электронной почты", copiedEmail: "Адрес электронной почты скопирован",
  ...
  en: {
    ...
    accepted: "EMAIL PREPARED", emailReady: "Review and send the message in your email application.",
    emailFallback: "Opening the application does not confirm sending. If it did not open, email monodev@gmail.com directly.", another: "Create another request",
    ...
    submit: "PREPARE EMAIL", copyEmail: "Copy email address", copiedEmail: "Email address copied",
...
export const copy = cmsContent("i18n-copy", {
  ro: {
    ...
    close: "Închide detaliile", fullLicense: "LICENȚĂ COMPLETĂ", fullPrice: "DE LA", requestDemo: "Solicită acces demo", openProject: "Deschide proiectul", buyFor: "Cumpără pentru", interested: "Interesat de", demoSubject: "Solicit acces demo pentru", rentalLabel: "CHIRIE LUNARĂ", rentalFrom: "la", perMonth: "/lunar", rentalIncludes: ["Găzduire gratuită primele 2 luni", "Mentenanță tehnică lunară gratuită primele 2 luni", "Poți cumpăra ulterior"], rentFor: "Închiriază la",
