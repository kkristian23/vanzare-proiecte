...
const projects = [
  ...
  { id: 10, title: "FIXORA", type: "Service Management", price: 1000, tone: "fixora", desc: "Sistem operațional pentru administrarea completă a unui service auto", stack: ["React", "TypeScript", "Vite", "LocalStorage", "CSV Export", "Dashboard", "Responsive UI", "Tailwind CSS", "Cloudflare"] },
...
const projectDetails: Record<number, {
  ...
  15: {
    ...
    sections: [
      ...
      { title: "Conturi și comunitate", items: ["Autentificare și înregistrare prin Firebase", "Profil personal cu istoric, favorite, mesaje și administrarea anunțurilor", "Statusuri de cont și protecție pe roluri pentru utilizatori și administratori", "Fluxuri pregătite pentru publicare, promovare și moderare"] },
      { title: "Panou de administrare", items: ["Gestionarea anunțurilor, utilizatorilor, companiilor și categoriilor", "Administrarea taxelor, bannerelor, mesajelor, notificărilor și conținutului informativ", "Arhivare, moderare, căutare și navigare prin module operaționale", "Structură extensibilă pentru reclame, concursuri, widgeturi și feedback"] },
      { title: "Tehnologie și livrare", items: ["Next.js 16, React 19 și TypeScript", "Firebase Authentication și infrastructură pregătită pentru date persistente", "Design responsive pentru telefon, tabletă și desktop", "Configurare Netlify și suită extinsă de teste Playwright"] },
      { title: "Ce primește cumpărătorul", items: ["Codul sursă complet și editabil", "Interfața publică, conturile utilizatorilor și panoul de administrare", "Structura pentru categorii, anunțuri, companii, promovări și conținut", "Bază pregătită pentru rebranding, integrarea plăților și lansare comercială"] },
    ],
  },
  14: {
...
export default function Home() {
  ...
  return <main>
    <div className="edge-rail edge-rail-left code-rail" aria-hidden="true"><div className="code-grid"/><div className="code-stream">{[0,1].map(copyIndex=><div className="code-stream-loop" key={copyIndex}><span><b>const</b> idea = <em>&quot;bold&quot;</em>;</span><span><b>while</b> (curious) build();</span><span><i>&lt;Launch</i> ready=<em>true</em> /&gt;</span><span>git commit -m <em>&quot;ship&quot;</em></span></div>)}</div><div className="code-core"><i>{`{`}</i><span>&lt;/&gt;</span><i>{`}`}</i></div><div className="terminal-chip"><b>●</b><span>BUILDING</span><i>_</i></div></div>
